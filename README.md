...
my [nixos](https://nixos.org/) and [home-manager](https://github.com/nix-community/home-manager/) configuration - a single flake driving 6 machines: two personal x86_64 boxes, three x86_64 vps nodes and one raspberry.
...
| `stockholm` | x86_64 | vps node |
| `helsinki` | x86_64 | vps node |
...
- `server/` - vps + pi config (`stockholm`, `helsinki`, `almaty`, `nest`)
- `secrets/` - sops store
